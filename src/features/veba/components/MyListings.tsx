/**
 * MyListings — Owner-facing management view of the current tenant's VEBA listings.
 *
 * Each row supports Pause / Reactivate / Archive lifecycle actions, gated by
 * can_edit_asset_listing via useGuardedMutation. The list re-fetches after
