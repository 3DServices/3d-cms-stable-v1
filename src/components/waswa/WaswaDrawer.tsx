 ...
 * assistant: POST /assistant/chat (surface "cms") and POST /assistant/feedback.
 *
 *   Header:  "Waswa AI • Co-Pilot Chat" + ON/OFF toggle
 *   Body:    AI (left, grey bubble) + user (right, green bubble). AI answers
 *            show a "Verified" chip when a staff-approved correction was used,
 *            and Helpful / Wrong buttons that feed the AI Console review queue.
...
const GREETING: ChatMessage = {
  id: "greeting",
  role: "ai",
  text: "Hi, I'm Waswa. Ask me about products, tokens, modules or procedures. "
      + "If an answer is wrong, tap Wrong — it goes to the AI Console for a fix.",
};

const DEFAULT_QUICK_ACTIONS = [
  { id: "tokens",   label: "How do tracking tokens work?" },
  { id: "sources",  label: "What documents can you use?"  },
  { id: "approval", label: "Who signs off an installation?" },
];
